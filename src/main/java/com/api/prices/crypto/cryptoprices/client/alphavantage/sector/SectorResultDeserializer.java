...
import com.api.prices.crypto.cryptoprices.client.alphavantage.utils.Regex;
...
public class SectorResultDeserializer extends JsonDeserializer<SectorResult> {
  ...
  public SectorResult deserialize(
    ...
    try {
      sectorResult.setMetaData(AlphaVantageResultDeserializerHelper.getMetaData(node));
